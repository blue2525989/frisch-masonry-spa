...
import com.frisch.model.EmailData;
import com.frisch.service.EmailService;
...
public class SendMailController {
	...
	public Map<String, Object> sendEmail(@RequestBody EmailData emailData) {
		...
		String saved = "";
		try {
			emailService.sendMail(emailData.getName(), emailData.getSubject(), 
					emailData.getEmail(), emailData.getPhone(), emailData.getMessage());
			saved = "Thank you, " + emailData.getName() + " " + emailData.getSubject() 
